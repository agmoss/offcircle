 ...
 * @function
 *
 * @param {Canvas.CanvasRenderingContext2D} ctx - Canvas context to render on
 * @param {number} ellipseCount - number of ellipses to draw
 *
 * @return {Void}
 */
const offCircle = (ctx, ellipseCount = 120) => {
